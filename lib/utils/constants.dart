...
class ApiConstants {
  ...
  static const String categoriesEndpoint =
      '$baseUrl/catalog/mobile/categories/';
  ...
  static String addToCartEndpoint(int productId) =>
      '$baseUrl/cart/flutter/add/$productId/';
  static String updateCartItemEndpoint(int itemId) =>
      '$baseUrl/cart/flutter/update/$itemId/';
  static String removeCartItemEndpoint(int itemId) =>
      '$baseUrl/cart/flutter/remove/$itemId/';
